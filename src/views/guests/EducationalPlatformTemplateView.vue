...
<body class="bg-gray-100 text-gray-800 antialiased">
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="relative">
            ...
            <div id="profile-dropdown" class="hidden absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg py-2 z-10">
              <router-link to="/profile" class="block px-4 py-2 text-gray-600 hover:bg-gray-100">View Profile</router-link>
    ...
    <div class="pt-16 max-w-7xl mx-auto flex flex-col lg:flex-row">
      ...
      <aside class="hidden xl:flex xl:flex-col xl:w-72 border-l bg-white px-4 py-6 space-y-8" id="chat">
        <!-- Profile card -->
